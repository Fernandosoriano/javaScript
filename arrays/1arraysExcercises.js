...
//Tuck in Array
// Create a function that takes two arrays and insert the second array in the
// middle of the first array.
// FUENTE: https://edabit.com/challenge/7ysTEDruHz2prcJQ9
// function tuckIn(arr1, arr2) {
//     if (arr1.length == 2) {
//         res = [arr1[0], ...arr2, arr1[1]]
//         return res
//     }

// }
tuckIn = (arr1, arr2) => (arr1.length == 2) ? res = [arr1[0], ...arr2, arr1[1]] :
    `la longitud del primer array no es valida`
